restTileGUID = 'd3f052'
restTileTwoGUID = '6d66ae'
prepareTileOneGUID = '3046ed'
prepareTileTwoGUID = 'caf0c6'
climbTileOneGUID = 'fc2893'
climbTileTwoGUID = '6c58fe'

playerColor = "Orange"
mainButtonColor = { r=0.89, g=0.7, b=0.25 }
undoButtonColor = { r=0.69, g=0.5, b=0.05 }
buttonTextColor = { 0, 0, 0 }

restSpinnerGUID = '9a5157'
prepareSpinnerGUID = '62be65'
climbSpinnerOneGUID = '6f2c59'
climbSpinnerTwoGUID = '5c47b3'
