restTileGUID = 'ec6c8b'
restTileTwoGUID = '90f3a1'
prepareTileOneGUID = 'ad9077'
prepareTileTwoGUID = '72f2ac'
climbTileOneGUID = 'c38b6f'
climbTileTwoGUID = '14ab59'

playerColor = "Red"
mainButtonColor = { r=0.89, g=0.25, b=0.25 }
undoButtonColor = { r=0.69, g=0.05, b=0.05 }
buttonTextColor = { 1, 1, 1 }

restSpinnerGUID = 'c75b29'
prepareSpinnerGUID = 'dd699d'
climbSpinnerOneGUID = 'ac5946'
climbSpinnerTwoGUID = '6d3f92'
