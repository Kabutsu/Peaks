restTileGUID = '032169'
restTileTwoGUID = 'b5301e'
prepareTileOneGUID = '83ccba'
prepareTileTwoGUID = 'e7a690'
climbTileOneGUID = '6f5adb'
climbTileTwoGUID = '57ddd9'

playerColor = "Green"
mainButtonColor = { r=0.55, g=0.7, b=0.31 }
undoButtonColor = { r=0.25, g=0.5, b=0.21 }
buttonTextColor = { 1, 1, 1 }

restSpinnerGUID = '0ffeeb'
prepareSpinnerGUID = '3fc970'
climbSpinnerOneGUID = '0c3cf1'
climbSpinnerTwoGUID = 'ac3618'
